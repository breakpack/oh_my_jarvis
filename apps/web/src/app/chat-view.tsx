...
const CONVERSATION_STORAGE_KEY = "pai:conversationId";
...
export function ChatView() {
  ...
  useEffect(() => {
    ...
    if (!storedId || !apiBaseUrl) return;

    fetch(`${apiBaseUrl}/api/v1/conversations/${storedId}`)
      .then((res) => {
      ...
      .catch(() => {
        ...
        setRestoreError("이전 대화를 불러오지 못했습니다. 새 대화를 시작합니다.");
      });
  }, []);
